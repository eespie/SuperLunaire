...
function Display:addBody(body)
    table.insert(self.bodies,body)
end

function Display:addJoint(joint)
...
function Display:draw()
    ...
    for i,body in ipairs(self.bodies) do
        ...
        elseif body.type == DYNAMIC then
            if body.linearVelocity.y < -maxSpeed then
                stroke(255, 0, 0, 255)
            else
...
function Display:touched(touch)
...
function Display:collide(contact)
